...
exports.appsRouter = void 0;
const express_1 = __importDefault(require("express"));
const cross_fetch_1 = __importDefault(require("cross-fetch"));
exports.appsRouter = express_1.default.Router();
exports.appsRouter.get("/appx_messenger", async (req, res) => {
...
exports.appsRouter.get("/msix_windows_terminal", async (req, res) => {
    const UPSTREAM_API = "https://store.rg-adguard.net/api/GetFiles";
